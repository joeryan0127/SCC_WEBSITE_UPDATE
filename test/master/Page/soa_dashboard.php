              ...
              <!-- <div class="col-sm-4 grid-margin">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-8 col-sm-12 col-xl-8 my-auto">
                        <h6 class="text-muted font-weight-normal"><a href="#">View Details</a></h6>
                      </div>
                      <div class="col-4 col-sm-12 col-xl-4 text-center text-xl-right">
                       <i class="icon-lg mdi mdi-codepen text-primary ml-auto"></i>
                      </div>
                       ...
                       <!--  <h5><?php echo $rowEvents['evnts_news'];?></h5> -->
                        <div class="row">
                          ...
                          <div class="col-4 col-sm-12 col-xl-4 text-center text-xl-right">
                           ...
                           <img style="width: 100%; height: 200px;" src="<?php echo (!empty($rowEvents['evnts_photo']))? '../images/'.$rowEvents['evnts_photo']:'../images/'; ?>" class="" >
                        </div>&nbsp;
