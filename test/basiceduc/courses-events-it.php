...
<!-- <section class="page-section">
    <header class="masthead bg-primary text-white text-center">
        <div class="container d-flex align-items-center flex-column"> -->
            ...
            <!-- <img class="masthead-avatar mb-5" src="../assets/img/it-course/it.jpg" alt="..." /> -->
            <!-- Masthead Heading-->
            <!-- <h4 class="masthead-heading text-uppercase mb-0" style="color:black">BSIT EVENTS</h4> -->
            <!-- Icon Divider-->
...
<!-- 
        ...
        <div class="container"> -->
            ...
            <!-- <div class="row justify-content-center"> -->
                ...
                <!-- <div class="col-md-6 col-lg-4 mb-5">
                    ...
                    <h2 class="portfolio-modal-title text-secondary text-uppercase mb-0">INTRAMURALS</h2>
                </div>
            </div>
        </div>
    </section> -->
    ...
    <!-- Portfolio Modals-->
    <!-- Portfolio Modal 1-->
    <div class="portfolio-modal modal fade" id="portfolioModal1<?php echo $q['id']; ?>" tabindex="-1" aria-labelledby="portfolioModal1" aria-hidden="true">
        <div class="modal-dialog ">
            <div class="modal-content">
                <div class="modal-header border-0"><button class="btn-close" type="button" class="close" data-bs-dismiss="modal" aria-label="Close"></button></div>
