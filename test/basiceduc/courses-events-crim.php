...
<section class="page-section">
    <header class="masthead bg-primary text-white text-center">
        <div class="container d-flex align-items-center flex-column">
            ...
            <img class="masthead-avatar mb-5" src="../assets/img/crim-course/crim.jpg" alt="..." />
            <!-- Masthead Heading-->
            <h4 class="masthead-heading text-uppercase mb-0" style="color:black">BSCRIM EVENTS</h4>
            <!-- Icon Divider-->
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-6 col-lg-4 mb-5">
                    ...
                    <h2 class="portfolio-modal-title text-secondary text-uppercase mb-0">Firing Range</h2>
                </div>
            </div>
        </div>
    </section>
