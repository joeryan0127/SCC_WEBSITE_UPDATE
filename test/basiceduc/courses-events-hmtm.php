...
<section class="page-section">
    <header class="masthead bg-primary text-white text-center">
        <div class="container d-flex align-items-center flex-column">
            ...
            <img class="masthead-avatar mb-5" src="../assets/img/hmtm-course/hmtm.jpg" alt="..." />
            <!-- Masthead Heading-->
            <h4 class="masthead-heading text-uppercase mb-0" style="color:black">BSHM | BSTM EVENTS</h4>
            <!-- Icon Divider-->
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-6 col-lg-4 mb-5">
                    ...
                    <h2 class="portfolio-modal-title text-secondary text-uppercase mb-0">HMTM | BSTM DAYS</h2>
                </div>
